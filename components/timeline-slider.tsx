  ...
  return (
    <div className="relative">
      <div className="flex items-center justify-between mb-4">
        ...
        <p className="text-sm text-muted-foreground hidden sm:block">Tap any point to jump through time</p>
      </div>
      ...
      <div className="relative overflow-x-auto scrollbar-hide">
        ...
        <div className="relative min-w-[800px] lg:min-w-full">
          ...
          {/* Event points */}
          <div className="relative flex justify-between items-center py-4 px-4">
            {events.map((event, index) => (
              <div key={index} className="flex flex-col items-center group flex-shrink-0">
                ...
                <div
                  className={`
                  mt-2 text-xs transition-all duration-300 text-center whitespace-nowrap
                  ${
                    index === currentIndex
